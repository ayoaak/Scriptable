...
class Widget extends DmYY {
  ...
  async checkAndUpdateScript() {
    const updateUrl = "https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/upcoming.json";
    ...
    return this.renderAppView([
      {
        ...
        menu: [
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/gradient.png',
            type: 'switch',
            title: '渐变进度条',
            desc: '',
            val: 'gradient',
      ...
      },
      {
        menu: [
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/step1.png',
            type: 'color',
            title: '流量进度条',
            defaultValue: '#20A162',
            desc: '',
          ...
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/step2.png',
            type: 'color',
            title: '语音进度条',
            defaultValue: '#FF6F61',
            desc: '',
      ...
      },
      {
        menu: [
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/logoColor.png',
            type: 'color',
            title: 'LOGO图标颜色',
            defaultValue: '#3F85AD',
            desc: '',
          ...
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/flowIconColor.png',
            type: 'color',
            title: '流量图标颜色',
            defaultValue: '#20A162',
            desc: '',
          ...
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/voiceIconColor.png',
            type: 'color',
            title: '语音图标颜色',
            defaultValue: '#FF6F61',
            desc: '',
      ...
      },
      {
        ...
        menu: [
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/clear.png',
            title: '重置颜色',
            desc: '重置当前颜色配置',
            name: 'reset',
            val: 'reset',
    ...
    return this.renderAppView([
      {
        ...
        menu: [
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/SCALE.png',
            type: 'input',
            title: '小组件缩放比例',
            desc: '',
            placeholder : '1',
      ...
      },
      {
        menu: [
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/ringStackSize.png',
            type: 'input',
            title: '圆环大小',
            placeholder : '65',
            desc: '',
          ...
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/ringTextSize.png',
            type: 'input',
            title: '圆环中心文字大小',
            placeholder : '14',
            desc: '',
      ...
      },
      {
        menu: [
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/feeTextSize.png',
            type: 'input',
            title: '话费文字大小',
            placeholder : '21',
            desc: '',
          ...
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/textSize.png',
            type: 'input',
            title: '文字模式下文字大小',
            placeholder : '13',
            desc: '',
      ...
      },
      {
        menu: [
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/smallPadding.png',
            type: 'input',
            title: '小尺寸组件边距',
            placeholder : '13',
            desc: '',
          ...
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/padding.png',
            type: 'input',
            title: '中尺寸组件边距',
            placeholder : '10',
            desc: '',
  ...
  Run() {
    if (config.runsInApp) {
      ...
      this.registerAction({
        ...
        menu: [
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/update.png',
            type: 'input',
            title: '脚本更新',
            name: 'update',
            onClick: async () => {
          ...
          {
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/widgetStyle.png',
            type: 'select',
            title: '组件样式',
            options: ['1', '2', '3', '4', '5', '6'],
            val: 'widgetStyle',
      ...
      this.registerAction({
        ...
        menu: [
          ...
          {
            name: 'size',
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/size.png',
            title: '尺寸设置',
            type: 'input',
            onClick: () => {
      ...
      this.registerAction({
        ...
        menu: [
          {
            name: 'cookie',
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/enableName.png',
            title: '账户设置',
            type: 'input',
            onClick: async () => {
      ...
      this.registerAction({
        ...
        menu: [
          {
            name: 'basic',
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/basic.png',
            title: '基础设置',
            type: 'input',
            onClick: () => {
          ...
          {
            name: 'reload',
            url: 'https://raw.githubusercontent.com/ayoaak/Scriptable/refs/heads/main/anker1209/icon/reload.png',
            title: '重载组件',
            type: 'input',
            onClick: () => {
              this.reopenScript();
